...
describe("OO入门", function(){
    it("对象之间的交互-5", function(){
        ...
        let classes=_class
        let teacher=new Teacher(23,'Tom',21,classes)
        expect(teacher.introduce()).toEqual('My name is Tom, I am 21 years old. I am a teacher, I teach class 2 3 4')
